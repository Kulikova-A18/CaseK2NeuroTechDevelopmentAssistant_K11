...
## 🏗️ Детальная схема взаимодействия компонентов
...
sequenceDiagram
    ...
    Note over Client,LLM: 1. Аутентификация пользователя
    ...
    Note over Client,LLM: 2. Создание задачи
    ...
    Note over Client,LLM: 3. Получение списка задач
    ...
    Note over Client,LLM: 4. Экспорт данных
    ...
    Note over Client,LLM: 5. LLM анализ
